				...
				<div class="panel-body">
					<div class="row">
						...
						<div class="input-field col s12 m6">
							...
							<input id="subject" name="subject" type="text" value="{{ $info->subject }}" required class="validate">
						</div>
					</div>
					<div class="row">
							...
							<div class="panel-section">
								<div class="row">
									...
									<div class="input-field col s12 m6">
										...
										<input id="address" name="address" type="text" value="{{ $info->address }}" class="validate">
									</div>
									<div class="input-field col s12 m6">
										<label for="emails">emails</label>
										<input id="emails" name="emails" type="text" value="{{ $info->emails }}" class="validate">
									</div>
									<div class="input-field col s12 m6">
										<label for="phones">phones</label>
										<input id="phones" name="phones" type="text" value="{{ $info->phones }}" class="validate">
									</div>
									<div class="input-field col s12">
										<label for="brief">Brief</label>
										<textarea id="brief" name="brief" class="materialize-textarea validate">{{ $info->brief }}</textarea>
									</div>
									<div class="clearfix"></div>
								</div>
								<div class="row">
									...
									<div class="input-field col s12 m6">
										...
										<input id="fb" name="fb" type="url" value="{{ $info->fb }}" class="validate">
									</div>
									<div class="input-field col s12 m6">
										<label for="tw">twitter</label>
										<input id="tw" name="tw" type="url" value="{{ $info->tw }}" class="validate">
									</div>
									<div class="input-field col s12 m6">
										<label for="google">google +</label><small class="helper-text"></small>
										<input id="google" name="google" type="url" value="{{ $info->google }}" class="validate">
									</div>
									<div class="input-field col s12 m6">
										<label for="youtube">youtube</label>
										<input id="youtube" name="youtube" type="url" value="{{ $info->youtube }}" class="validate">
									</div>
									<div class="input-field col s12 m6">
										<label for="pint">Pinterest</label>
										<input id="pint" name="pint" type="url" value="{{ $info->pint }}" class="validate">
									</div>
									<div class="input-field col s12 m6">
										<label for="instagram">instagram</label>
										<input id="instagram" name="instagram" type="url" value="{{ $info->instagram }}" class="validate">
									</div>
								</div>
								<div class="row">
									...
									<div class="input-field col s12 m6">
										...
										<input id="map" name="map" type="text" value="{{ $info->map }}" class="validate">
									</div>
								</div>
							</div>
					</div>
