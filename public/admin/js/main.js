...
function initiate() {
    ...
    function a(a) {
        $.ajax({
            ...
            success: function(a) {
                var b = $(a),
                    g = (b.find("title").text(), b.find("#wrapper").html()),
                    h = b.filter("div#scripts").html();
                c.html(g), d.html(h), f.velocity("stop").velocity({
                    opacity: 0
                }, {
                    display: "none",
                    complete: function() {
                        f.remove(), c.velocity("stop").velocity({
                            opacity: 1
                        }, {
                            display: "block",
                            duration: 150,
    ...
    var c = $("#wrapper"),
        d = $("#scripts"),
        e = $("#slide-out a,.brand-logo"),
        f = $('<div id="main-progress"> <div class="wrapper"> <p>Getting your content ...</p><div class="progress"><div class="indeterminate"></div></div></div></div>'),
        g = function(b) {
            c.velocity({
                opacity: 0
            }, {
    ...
    window.onpopstate = function() {
        ...
        var c = $(this),
            d = c.attr("href"),
            f = b(d);
        return c.hasClass("disabled") || c.hasClass("active") ? !1 : (e.addClass("disabled"), e.removeClass("active"), c.addClass("active"), history.pushState({}, "", f.pathname), void g(d))
    })
});